...
//go:generate go run github.com/deepmap/oapi-codegen/v2/cmd/oapi-codegen --package=api --generate types -o petstore-types.gen.go ../../petstore-expanded.yaml
//go:generate go run github.com/deepmap/oapi-codegen/v2/cmd/oapi-codegen --package=api --generate server,spec -o petstore-server.gen.go ../../petstore-expanded.yaml
